...
export default function ProfilePage() {
  ...
  return (
    <>
      <Head>
        <title>Accanto | Profile — Ghassen Mansouri</title>
        <meta
          name="description"
          content="Ghassen Mansouri — OSS certificato, libero professionista. 8 anni socio-sanitario, 10 anni hospitality. IT · EN · FR · AR · DE. Como · Lecco · Milano."
        />
      </Head>
          ...
          <div className="profile-hero-inner">
            ...
            <div>
              ...
              <div className="profile-role">
                OSS · Libero professionista registrato · Como Lake – Lecco / Valtellina
              </div>
              <div className="profile-chips">
                <span className="chip chip-accent">OSS · Libero professionista registrato</span>
                <span className="chip">5 languages</span>
                <span className="chip">18 years exp.</span>
              ...
              <p className="profile-bio">
                ...
                Italian, English, French, Arabic, and German. Human approach, professional
                structure, no compromises.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="method-list">
              <div className="method-item">
                ...
                <div className="method-body">
                  <div className="method-title">Structured onboarding</div>
                  <div className="method-desc">
                    First dedicated visit: habits, routines, preferences, limitations. Personal form
                    completed before the first procedure.
                  </div>
                  <div className="method-benefit">
                    You receive care that fits — not a generic protocol applied to every client.
                  </div>
                </div>
              </div>
              <div className="method-item">
                ...
                <div className="method-body">
                  ...
                  <div className="method-benefit">
                    You always know what happened during the session, even when you weren't there.
                  </div>
                </div>
              </div>
              <div className="method-item">
            ...
            <div className="philosophy-block">
              <div className="philosophy-item">
                <div className="philosophy-quote">
                  “A professional caregiver protects tools. A conscious caregiver respects the
                  person they're caring for — with structure, method, and the ability to understand
                  what's truly needed, even before it is said.”
                </div>
              </div>
              <div className="philosophy-item">
                <div className="philosophy-quote">
          ...
          <div className="section-inner">
            ...
            <div className="area-grid">
              ...
              <div className="area-card">
                ...
                <div className="area-desc">Expat clientele and international families. Accepted upon evaluation.</div>
              </div>
              <div className="area-card">
                <div className="area-tag">Minimum per support session</div>
                <div className="area-title">5 hours</div>
                <div className="area-desc">Minimum duration for each intervention. No exceptions. Defined contractually.</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="section-inner narrow">
            ...
            <div className="discovery-steps">
              ...
              <div className="discovery-step">
                ...
                <div className="discovery-text">If compatible: a calendar link will be shared with you.</div>
              </div>
              <div className="discovery-step">
            ...
            <div className="cta-you">
              <div className="cta-you-label">YOU'VE READ ENOUGH</div>
